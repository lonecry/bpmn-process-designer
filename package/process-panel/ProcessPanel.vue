        ...
        <el-collapse v-model="activeTab">
                ...
                <div class="panel-tab__content">
                    <el-form size="mini" label-width="90px">
                        <el-form-item label="ID">
                            <el-input v-model="elementBaseInfo.id" :disabled="idEditDisabled || elementType === 'bpmn:Process'" clearable @keyup.enter.native="updateBaseId(elementBaseInfo.id)" />
                        </el-form-item>
                        <el-form-item label="名称">
                            <el-input v-model="elementBaseInfo.name" clearable @keyup.native="updateBaseInfo('name', elementBaseInfo.name)" @change="updateBaseInfo('name', $event)" />
                        </el-form-item>
                        <!--流程的基础属性-->
                        <template v-if="elementType === 'bpmn:Process'">
                            <el-form-item label="版本标签">
                                <el-input v-model="elementBaseInfo.versionTag" clearable @keyup.native="updateBaseInfo('versionTag', elementBaseInfo.versionTag)" @change="updateBaseInfo('versionTag', $event)" />
                            </el-form-item>
                    ...
                    <template v-if="elementType === 'bpmn:UserTask'">
                        <div class="element-property input-property">
                            ...
                            <div class="element-property__value">
                                <el-select v-model="activeElementBusinessObject.assignee" size="mini" @change="updateBaseInfo('assignee', activeElementBusinessObject.assignee)">
                        ...
                        <div class="element-property input-property">
                            ...
                            <div class="element-property__value">
                                <el-select v-model="activeElementBusinessObject.candidateUsers" size="mini" @change="updateBaseInfo('candidateUsers', activeElementBusinessObject.candidateUsers)">
                        ...
                        <div class="element-property input-property">
                            ...
                            <div class="element-property__value">
                                <el-select v-model="activeElementBusinessObject.candidateGroups" size="mini" @change="updateBaseInfo('candidateGroups', activeElementBusinessObject.candidateGroups)">
            ...
            <template v-if="elementType === 'bpmn:UserTask' || elementType === 'bpmn:StartEvent'">
                <el-collapse-item name="form">
                    ...
                    <element-form-config v-bind="$props" :element-id="elementId" :element-business-object="activeElementBusinessObject" @change-form-key="updateBaseInfo('formKey', $event)" />
                </el-collapse-item>
            </template>
